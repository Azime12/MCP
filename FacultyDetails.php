...
<div class="container">
	...
	<div class="row">
		<div class="col-md-8">
			...
			echo "<h3 class='page-header' >Consultant Details</h3>";
			...
			<a href="addnewfaculty"><button type="button" value="Add New Faculty" class="btn btn-info btn-sm">Add New consultant</button></a>

...
<div class="container">
		...
		if ( isset( $_POST[ 'addnews' ] ) ) {
			...
			if ( mysqli_query( $connect, $sql ) ) {
				...
				<h3 style='margin-top: 10px; margin-bottom: 10px;'>Admission Confirm.! Student ID is : <span style='color:black'><strong>" . mysqli_insert_id( $connect ) . "</strong></span></h4></div></center>
				";
			} else {
